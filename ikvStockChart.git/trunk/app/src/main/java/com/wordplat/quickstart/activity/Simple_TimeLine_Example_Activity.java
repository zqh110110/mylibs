...
import com.wordplat.ikvstockchart.drawing.TimeVolumeDrawing;
...
public class Simple_TimeLine_Example_Activity extends BaseActivity {
    ...
    private TimeLineRender mTimeRender;
    ...
    private void initUI() {
        ...
        mTimeRender = new TimeLineRender();
        StockKLineVolumeIndex kLineVolumeIndex = new StockKLineVolumeIndex(80);
        kLineVolumeIndex.addDrawing(new TimeVolumeDrawing());
        kLineVolumeIndex.addDrawing(new KLineVolumeHighlightDrawing());
        mTimeRender.addStockIndex(kLineVolumeIndex);
        timeLineView.setRender(mTimeRender);
    }
