...
public class TradeRuleActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!SharePersistent.getInstance().getPerference(getApplicationContext(), "TradeRule").toString().equals("")) {
			tv1.setText(SharePersistent.getInstance().getPerference(getApplicationContext(), "TradeRule"));
		}else {
			getData();
		}
	...
	private Handler updateUIHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case 1:
				...
				SharePersistent.getInstance().savePerference(getApplicationContext(), "TradeRule", ruleString);
