package com.kfd.ui;
	 ...
	 */
	public class PullToRefreshListViewSecond extends ListView implements OnScrollListener {
		...
		public PullToRefreshListViewSecond(Context context, AttributeSet attrs) {
			super(context, attrs);
			init(context);
		}
