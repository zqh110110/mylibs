...
import com.kfd.activityfour.LogoActivity;
...
public class UpdateService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		// 设置任务栏中下载进程显示的views
		views = new RemoteViews(getPackageName(), R.layout.update_download);
		notification.contentView = views;

		PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
				new Intent(this, LogoActivity.class), 0);
				...
				try {
					...
					if (is != null) {
						File rootFile = new File(
								...
								"/pinke");
						// File rootFile=new
						// File(Environment.getExternalStorageDirectory()+"/pinke");
